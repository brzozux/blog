            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header page-scroll">
					...
					if($_SESSION['logged']) {
						...
						echo "zarejestruj sie aby zobaczyć pełny content	!";
						
						//strona z loginem i rejestracja
					}
					db_close();
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a href="about.html">O Mnie<br></a>
                        </li>
                        <li>
                            <a href="contact.html">Kontakt<br></a>
                        </li>
                        <li>
                            <a href="register.php">Zarejestruj<br></a>
                        </li>
                        <li class="login">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="post-preview">
                        <a href="post.html" class=""><h2 class="post-title">
                    ...
                    <hr>
                    <div class="post-preview">
                        <a href="post.html"><h2 class="post-title">
